        ...
        remoteConfig: [
          {
            ...
            options: [
              ...
              {
                label: "殊途",
                value: "https://code.shutu736.cn/shutu/rule-config/raw/branch/main/shutu_template.ini",
              },
              {
                label: "默认（自动测速）",
                value:
    ...
    getBackendVersion() {
      this.$axios
        ...
        .then((res) => {
          ...
          let a =
            this.form.customBackend.indexOf("url.v1.mk") !== -1 || this.form.customBackend.indexOf("sub.d1.mk") !== -1;
